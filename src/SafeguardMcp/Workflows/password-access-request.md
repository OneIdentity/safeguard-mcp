...
tags: password, access request, checkout, check-in, credential, workflow
---
...
Typical workflow: Request → Approve → Available → View Password → Check-in → (Auto-rotate)

Steps:
1. Find requestable accounts for the current user:
...
2. Create a password access request:
...
4. Retrieve the password (once Available):
...
6. Verify the request completed:
